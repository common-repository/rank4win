<div id="r4w_sst_subpage_[@type_slug]" class="page_subtab">
	...
	<div class="r4w_bullet_info">
		...
		<div class="css-df5r0grg">
			{_('You can customize your meta title and default description')}.
		</div>
	</div>
	<div class="switch r4w_autosave_info">
		<label>
			<input type="checkbox" class="r4w_autosave" name="seo_settings|types_content|[@type_slug]|editing_meta" [@editing_meta]>
			<span class="lever"></span>
			[@type_txt_edititng_meta]
		</label>
	</div>
	...
	<div class="switch r4w_autosave_info">
		<label>
			<input type="checkbox" class="r4w_autosave r4w_types_content_index" name="seo_settings|types_content|[@type_slug]|index" [@index]>
			<span class="lever"></span>
			[@type_text_index]
		</label>
	</div>
	<div class="r4w_additional_info">
		[@type_additional_info_index]
	</div>
    <div class="switch r4w_autosave_info">
		<label>
			<input type="checkbox" class="r4w_autosave" name="seo_settings|types_content|[@type_slug]|follow" [@follow]>
			<span class="lever"></span>
			[@type_text_follow]
		</label>
	</div>
	<div class="r4w_additional_info">
		[@type_additionnal_info_follow]
	</div>
	<div class="r4w_atwho_box select-field">
		...
		<div class="r4w_autosave_info r4w_progress_div">
			<input class="athow_input r4w_autosave" name="seo_settings|types_content|[@type_slug]|meta_title"></input>
	...
	<div class="r4w_atwho_box select-field athow_lg">
		...
		<div class="btn_add_tag"><div class="css-25c58628966c">[@svg_add_more]</div></div>
		<div class="r4w_autosave_info r4w_progress_div">
			<input class="athow_input r4w_autosave" name="seo_settings|types_content|[@type_slug]|meta_description" ></input>
